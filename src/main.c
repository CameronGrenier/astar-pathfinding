...
static int show_results(double elapsed_sec)
{
    ...
    for (int i = 0; i < num_agents; i++) {
        ...
        if (coords_per_line < 1) coords_per_line = 1;
    ...
    for (;;) {
        ...
        if (ch == KEY_DOWN && scroll_offset < max_scroll) { scroll_offset++; }
    ...
    if (use_cli_args) {
        ...
        for (int i = 2; i < argc - 1; i++) {
            if (strcmp(argv[i], "-speed") == 0) {
                ...
                if      (strcmp(s, "slow")     == 0) speed_delay = 500000;
                else if (strcmp(s, "medium")   == 0) speed_delay = 100000;
                else if (strcmp(s, "fast")     == 0) speed_delay = 20000;
                else if (strcmp(s, "realtime") == 0) speed_delay = 0;
                else {
